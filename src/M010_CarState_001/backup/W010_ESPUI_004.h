...
void W010_EmbUI_setupWebPages() {
    ...
    g_W010_Tab_Config_Id = ESPUI.addControl(Tab, "시스템 설정", "시스템 설정");


    // 이제 g_configPageId를 부모 ID로 사용하여 해당 페이지에 컨트롤을 추가합니다.
    ESPUI.addControl(ControlType::Number, "가속도 필터 Alpha", String(g_M010_Config.mvState_accelFilter_Alpha, 3), ControlColor::Alizarin, g_W010_Tab_Config_Id, &W010_ESPUI_callback, (void*)C_ID_MVSTATE_ACCELFILTER_ALPHA);
    ESPUI.addControl(ControlType::Number, "전진 시작 속도 (km/h)", String(g_M010_Config.mvState_Forward_speedKmh_Threshold_Min, 2), ControlColor::Alizarin, g_W010_Tab_Config_Id, &W010_ESPUI_callback, (void*)C_ID_MVSTATE_FORWARD_SPEEDKMH_THRESHOLD_MIN);
    ESPUI.addControl(ControlType::Number, "후진 시작 속도 (km/h)", String(g_M010_Config.mvState_Reverse_speedKmh_Threshold_Min, 2), ControlColor::Alizarin, g_W010_Tab_Config_Id, &W010_ESPUI_callback, (void*)C_ID_MVSTATE_REVERSE_SPEEDKMH_THRESHOLD_MIN);
    ESPUI.addControl(ControlType::Number, "정지 판단 최대 속도 (km/h)", String(g_M010_Config.mvState_Stop_speedKmh_Threshold_Max, 2), ControlColor::Alizarin, g_W010_Tab_Config_Id, &W010_ESPUI_callback, (void*)C_ID_MVSTATE_STOP_SPEEDKMH_THRESHOLD_MAX);
    ESPUI.addControl(ControlType::Number, "정지 판단 Y Accel (m/s^2)", String(g_M010_Config.mvState_Stop_accelMps2_Threshold_Max, 2), ControlColor::Alizarin, g_W010_Tab_Config_Id, &W010_ESPUI_callback, (void*)C_ID_MVSTATE_STOP_ACCELMPS2_THRESHOLD_MAX);
    ESPUI.addControl(ControlType::Number, "정지 판단 Yaw Gyro (deg/s)", String(g_M010_Config.mvState_Stop_gyroDps_Threshold_Max, 2), ControlColor::Alizarin, g_W010_Tab_Config_Id, &W010_ESPUI_callback, (void*)C_ID_MVSTATE_STOP_GYRODPS_THRESHOLD_MAX);
    ESPUI.addControl(ControlType::Number, "정지 안정 최소 시간 (ms)", String(g_M010_Config.mvState_stop_durationMs_Stable_Min), ControlColor::Alizarin, g_W010_Tab_Config_Id, &W010_ESPUI_callback, (void*)C_ID_MVSTATE_STOP_DURATIONMS_STABLE_MIN);
    ESPUI.addControl(ControlType::Number, "움직임 안정 최소 시간 (ms)", String(g_M010_Config.mvState_move_durationMs_Stable_Min), ControlColor::Alizarin, g_W010_Tab_Config_Id, &W010_ESPUI_callback, (void*)C_ID_MVSTATE_MOVE_DURATIONMS_STABLE_MIN);
    ESPUI.addControl(ControlType::Number, "급감속 Accel Y (m/s^2)", String(g_M010_Config.mvState_Decel_accelMps2_Threshold, 2), ControlColor::Alizarin, g_W010_Tab_Config_Id, &W010_ESPUI_callback, (void*)C_ID_MVSTATE_DECEL_ACCELMPS2_THRESHOLD);
    ESPUI.addControl(ControlType::Number, "방지턱 Accel Z (m/s^2)", String(g_M010_Config.mvState_Bump_accelMps2_Threshold, 2), ControlColor::Alizarin, g_W010_Tab_Config_Id, &W010_ESPUI_callback, (void*)C_ID_MVSTATE_BUMP_ACCELMPS2_THRESHOLD);
    ESPUI.addControl(ControlType::Number, "방지턱 최소 속도 (km/h)", String(g_M010_Config.mvState_Bump_SpeedKmh_Min, 2), ControlColor::Alizarin, g_W010_Tab_Config_Id, &W010_ESPUI_callback, (void*)C_ID_MVSTATE_BUMP_SPEEDKMH_MIN);
    ESPUI.addControl(ControlType::Number, "방지턱 쿨다운 (ms)", String(g_M010_Config.mvState_Bump_CooldownMs), ControlColor::Alizarin, g_W010_Tab_Config_Id, &W010_ESPUI_callback, (void*)C_ID_MVSTATE_BUMP_COOLDOWNMS);
    ESPUI.addControl(ControlType::Number, "급감속 유지 시간 (ms)", String(g_M010_Config.mvState_Decel_durationMs_Hold), ControlColor::Alizarin, g_W010_Tab_Config_Id, &W010_ESPUI_callback, (void*)C_ID_MVSTATE_DECEL_DURATIONMS_HOLD);
    ESPUI.addControl(ControlType::Number, "방지턱 유지 시간 (ms)", String(g_M010_Config.mvState_Bump_durationMs_Hold), ControlColor::Alizarin, g_W010_Tab_Config_Id, &W010_ESPUI_callback, (void*)C_ID_MVSTATE_BUMP_DURATIONMS_HOLD);
    ESPUI.addControl(ControlType::Number, "신호대기1 (초)", String(g_M010_Config.mvState_signalWait1_Seconds), ControlColor::Alizarin, g_W010_Tab_Config_Id, &W010_ESPUI_callback, (void*)C_ID_MVSTATE_SIGNALWAIT1_SECONDS);
    ESPUI.addControl(ControlType::Number, "신호대기2 (초)", String(g_M010_Config.mvState_signalWait2_Seconds), ControlColor::Alizarin, g_W010_Tab_Config_Id, &W010_ESPUI_callback, (void*)C_ID_MVSTATE_SIGNALWAIT2_SECONDS);
    ESPUI.addControl(ControlType::Number, "정차1 (초)", String(g_M010_Config.mvState_stopped1_Seconds), ControlColor::Alizarin, g_W010_Tab_Config_Id, &W010_ESPUI_callback, (void*)C_ID_MVSTATE_STOPPED1_SECONDS);
    ESPUI.addControl(ControlType::Number, "정차2 (초)", String(g_M010_Config.mvState_stopped2_Seconds), ControlColor::Alizarin, g_W010_Tab_Config_Id, &W010_ESPUI_callback, (void*)C_ID_MVSTATE_STOPPED2_SECONDS);
    ESPUI.addControl(ControlType::Number, "주차 (초)", String(g_M010_Config.mvState_park_Seconds), ControlColor::Alizarin, g_W010_Tab_Config_Id, &W010_ESPUI_callback, (void*)C_ID_MVSTATE_PARK_SECONDS);
    ESPUI.addControl(ControlType::Number, "시리얼 출력 간격 (ms)", String(g_M010_Config.serialPrint_intervalMs), ControlColor::Alizarin, g_W010_Tab_Config_Id, &W010_ESPUI_callback, (void*)C_ID_SERIALPRINT_INTERVALMS);
    ESPUI.addControl(ControlType::Number, "직진 Yaw Thres (deg/s)", String(g_M010_Config.turnState_Center_yawAngleVelocityDegps_Thresold, 2), ControlColor::Alizarin, g_W010_Tab_Config_Id, &W010_ESPUI_callback, (void*)C_ID_TURNSTATE_CENTER_YAWANGLEVELOCITYDEGPS_THRESOLD);
    ESPUI.addControl(ControlType::Number, "LR1 Yaw Thres (deg/s)", String(g_M010_Config.turnState_LR_1_yawAngleVelocityDegps_Thresold, 2), ControlColor::Alizarin, g_W010_Tab_Config_Id, &W010_ESPUI_callback, (void*)C_ID_TURNSTATE_LR_1_YAWANGLEVELOCITYDEGPS_THRESOLD);
    ESPUI.addControl(ControlType::Number, "LR2 Yaw Thres (deg/s)", String(g_M010_Config.turnState_LR_2_yawAngleVelocityDegps_Thresold, 2), ControlColor::Alizarin, g_W010_Tab_Config_Id, &W010_ESPUI_callback, (void*)C_ID_TURNSTATE_LR_2_YAWANGLEVELOCITYDEGPS_THRESOLD);
    ESPUI.addControl(ControlType::Number, "LR3 Yaw Thres (deg/s)", String(g_M010_Config.turnState_LR_3_yawAngleVelocityDegps_Thresold, 2), ControlColor::Alizarin, g_W010_Tab_Config_Id, &W010_ESPUI_callback, (void*)C_ID_TURNSTATE_LR_3_YAWANGLEVELOCITYDEGPS_THRESOLD);
    ESPUI.addControl(ControlType::Number, "회전 최소 속도 (km/h)", String(g_M010_Config.turnState_speedKmh_MinSpeed, 2), ControlColor::Alizarin, g_W010_Tab_Config_Id, &W010_ESPUI_callback, (void*)C_ID_TURNSTATE_SPEEDKMH_MINSPEED);
    ESPUI.addControl(ControlType::Number, "고속 회전 임계 (km/h)", String(g_M010_Config.turnState_speedKmh_HighSpeed_Threshold, 2), ControlColor::Alizarin, g_W010_Tab_Config_Id, &W010_ESPUI_callback, (void*)C_ID_TURNSTATE_SPEEDKMH_HIGHSPEED_THRESHOLD);
    ESPUI.addControl(ControlType::Number, "회전 안정 시간 (ms)", String(g_M010_Config.turnState_StableDurationMs), ControlColor::Alizarin, g_W010_Tab_Config_Id, &W010_ESPUI_callback, (void*)C_ID_TURNSTATE_STABLEDURATIONMS);

    ESPUI.addControl(ControlType::Button, "설정 저장", "save_config",   ControlColor::Emerald, g_W010_Tab_Config_Id, &W010_ESPUI_callback, (void*)C_ID_SAVE_CONFIG_BTN);
    ESPUI.addControl(ControlType::Button, "설정 불러오기", "load_config", ControlColor::Carrot, g_W010_Tab_Config_Id, &W010_ESPUI_callback, (void*)C_ID_LOAD_CONFIG_BTN);
    ESPUI.addControl(ControlType::Button, "설정 초기화", "reset_config", ControlColor::Alizarin, g_W010_Tab_Config_Id, &W010_ESPUI_callback, (void*)C_ID_RESET_CONFIG_BTN);


    // 'statusPage' 생성 및 컨트롤 추가
    g_W010_Tab_Status_Id = ESPUI.addControl(ControlType::Tab, "자동차 현재 상태", "", ControlColor::Wetasphalt);
    ESPUI.setVertical(g_W010_Tab_Status_Id, true);

    ///// g_W010_Tab_Status_Id = ESPUI.addControl(Control::Type::Page, "자동차 현재 상태", "", ControlColor::Wetasphalt, Control::Vertical);

    // 이제 g_statusPageId를 부모 ID로 사용하여 해당 페이지에 컨트롤을 추가합니다.
    ESPUI.addControl(ControlType::Label, "움직임 상태:"       , "정보 없음", ControlColor::Wetasphalt, g_W010_Tab_Status_Id, nullptr, (void*)C_ID_CARMOVEMENTSTATE_LABEL);
    ESPUI.addControl(ControlType::Label, "회전 상태:"         , "정보 없음", ControlColor::Wetasphalt, g_W010_Tab_Status_Id, nullptr, (void*)C_ID_CARTURNSTATE_LABEL);
    ESPUI.addControl(ControlType::Label, "추정 속도:"         , "0.00 km/h", ControlColor::Wetasphalt, g_W010_Tab_Status_Id, nullptr, (void*)C_ID_SPEED_KMH_LABEL);
    ESPUI.addControl(ControlType::Label, "AccelX (m/s^2):"  , "0.00 m/s^2", ControlColor::Wetasphalt, g_W010_Tab_Status_Id, nullptr, (void*)C_ID_ACCELX_MS2_LABEL);
    ESPUI.addControl(ControlType::Label, "AccelY (m/s^2):"  , "0.00 m/s^2", ControlColor::Wetasphalt, g_W010_Tab_Status_Id, nullptr, (void*)C_ID_ACCELY_MS2_LABEL);
    ESPUI.addControl(ControlType::Label, "AccelZ (m/s^2):"  , "0.00 m/s^2", ControlColor::Wetasphalt, g_W010_Tab_Status_Id, nullptr, (void*)C_ID_ACCELZ_MS2_LABEL);
    ESPUI.addControl(ControlType::Label, "Yaw (도):"        , "0.00 도", ControlColor::Wetasphalt, g_W010_Tab_Status_Id, nullptr, (void*)C_ID_YAWANGLE_DEG_LABEL);
    ESPUI.addControl(ControlType::Label, "Pitch (도):"      , "0.00 도", ControlColor::Wetasphalt, g_W010_Tab_Status_Id, nullptr, (void*)C_ID_PITCHANGLE_DEG_LABEL);
    ESPUI.addControl(ControlType::Label, "Yaw 속도 (도/초):"    , "0.00 도/초", ControlColor::Wetasphalt, g_W010_Tab_Status_Id, nullptr, (void*)C_ID_YAWANGLEVELOCITY_DEGPS_LABEL);
    ESPUI.addControl(ControlType::Label, "급감속 감지:", "아님" , ControlColor::Wetasphalt, g_W010_Tab_Status_Id, nullptr, (void*)C_ID_ISEMERGENCYBRAKING_LABEL);
    ESPUI.addControl(ControlType::Label, "방지턱 감지:", "아님" , ControlColor::Wetasphalt, g_W010_Tab_Status_Id, nullptr, (void*)C_ID_ISSPEEDBUMPDETECTED_LABEL);
    ESPUI.addControl(ControlType::Label, "정차 지속 시간:", "0 초", ControlColor::Wetasphalt, g_W010_Tab_Status_Id, nullptr, (void*)C_ID_CURRENTSTOPTIME_SEC_LABEL);


    g_W010_Control_Alaram_Id = ESPUI.addControl(ControlType::Label, "알림", "", ControlColor::Wetasphalt, g_W010_Tab_Status_Id);
    g_W010_Control_Error_Id = ESPUI.addControl(ControlType::Label, "오류", "", ControlColor::Wetasphalt, g_W010_Tab_Status_Id);
