...
#define     G_W010_UI_CONFIG_JSON_FILE     "/W010_ESPUI_ui_config_002.json"
 ...
 */
void W010_EmbUI_updateCarStatusWeb() {
    // 상태 문자열 및 단위, 메시지 JSON에서 가져오기
    JsonObject statusTab = g_W010_uiConfigDoc["tabs"][1]; // "status" 탭
    JsonObject movementStates = statusTab["car_movement_states"];
    JsonObject turnStates = statusTab["car_turn_states"];
    JsonObject booleanStates = statusTab["boolean_states"];
    JsonObject units = statusTab["units"];
    JsonObject messages = statusTab["messages"];

    String v_movementStateStr;
    switch (g_M010_CarStatus.carMovementState) {
        case E_M010_CARMOVESTATE_UNKNOWN:
            v_movementStateStr = movementStates["E_M010_CARMOVESTATE_UNKNOWN"].as<String>();
            break;
        case E_M010_CARMOVESTATE_STOPPED_INIT:
            v_movementStateStr = movementStates["E_M010_CARMOVESTATE_STOPPED_INIT"].as<String>();
            break;
        case E_M010_CARMOVESTATE_SIGNAL_WAIT1:
            v_movementStateStr = movementStates["E_M010_CARMOVESTATE_SIGNAL_WAIT1"].as<String>() + F(" (") + String(g_M010_Config.mvState_signalWait1_Seconds) + messages["signal_wait1_suffix"].as<String>();
            break;
        case E_M010_CARMOVESTATE_SIGNAL_WAIT2:
            v_movementStateStr = movementStates["E_M010_CARMOVESTATE_SIGNAL_WAIT2"].as<String>() + F(" (") + String(g_M010_Config.mvState_signalWait2_Seconds) + messages["signal_wait2_suffix"].as<String>();
            break;
        case E_M010_CARMOVESTATE_STOPPED1:
            v_movementStateStr = movementStates["E_M010_CARMOVESTATE_STOPPED1"].as<String>() + F(" (") + String(g_M010_Config.mvState_stopped1_Seconds / 60) + messages["stopped1_suffix"].as<String>();
            break;
        case E_M010_CARMOVESTATE_STOPPED2:
            v_movementStateStr = movementStates["E_M010_CARMOVESTATE_STOPPED2"].as<String>() + F(" (") + String(g_M010_Config.mvState_stopped2_Seconds / 60) + messages["stopped2_suffix"].as<String>();
            break;
        case E_M010_CARMOVESTATE_PARKED:
            v_movementStateStr = movementStates["E_M010_CARMOVESTATE_PARKED"].as<String>() + messages["parked_prefix"].as<String>() + String(g_M010_Config.mvState_park_Seconds / 60) + messages["parked_suffix"].as<String>();
            break;
        case E_M010_CARMOVESTATE_FORWARD:
            v_movementStateStr = movementStates["E_M010_CARMOVESTATE_FORWARD"].as<String>();
            break;
        case E_M010_CARMOVESTATE_REVERSE:
            v_movementStateStr = movementStates["E_M010_CARMOVESTATE_REVERSE"].as<String>();
            break;
    }
    ...
    switch (g_M010_CarStatus.carTurnState) {
        case E_M010_CARTURNSTATE_CENTER:
            v_turnStateStr = turnStates["E_M010_CARTURNSTATE_CENTER"].as<String>();
            break;
        case E_M010_CARTURNSTATE_LEFT_1:
            v_turnStateStr = turnStates["E_M010_CARTURNSTATE_LEFT_1"].as<String>();
            break;
        case E_M010_CARTURNSTATE_LEFT_2:
            v_turnStateStr = turnStates["E_M010_CARTURNSTATE_LEFT_2"].as<String>();
            break;
        case E_M010_CARTURNSTATE_LEFT_3:
            v_turnStateStr = turnStates["E_M010_CARTURNSTATE_LEFT_3"].as<String>();
            break;
        case E_M010_CARTURNSTATE_RIGHT_1:
            v_turnStateStr = turnStates["E_M010_CARTURNSTATE_RIGHT_1"].as<String>();
            break;
        case E_M010_CARTURNSTATE_RIGHT_2:
            v_turnStateStr = turnStates["E_M010_CARTURNSTATE_RIGHT_2"].as<String>();
            break;
        case E_M010_CARTURNSTATE_RIGHT_3:
            v_turnStateStr = turnStates["E_M010_CARTURNSTATE_RIGHT_3"].as<String>();
            break;
    }
    ...
    ESPUI.updateControlValue(C_ID_SPEED_KMH_LABEL, String(g_M010_CarStatus.speed_kmh, 2) + units["speed"].as<String>());
    ESPUI.updateControlValue(C_ID_ACCELX_MS2_LABEL, String(g_M010_CarStatus.accelX_ms2, 2) + units["accel"].as<String>());
    ESPUI.updateControlValue(C_ID_ACCELY_MS2_LABEL, String(g_M010_CarStatus.accelY_ms2, 2) + units["accel"].as<String>());
    ESPUI.updateControlValue(C_ID_ACCELZ_MS2_LABEL, String(g_M010_CarStatus.accelZ_ms2, 2) + units["accel"].as<String>());
    ESPUI.updateControlValue(C_ID_YAWANGLE_DEG_LABEL, String(g_M010_CarStatus.yawAngle_deg, 2) + units["angle"].as<String>());
    ESPUI.updateControlValue(C_ID_PITCHANGLE_DEG_LABEL, String(g_M010_CarStatus.pitchAngle_deg, 2) + units["angle"].as<String>());
    ESPUI.updateControlValue(C_ID_YAWANGLEVELOCITY_DEGPS_LABEL, String(g_M010_CarStatus.yawAngleVelocity_degps, 2) + units["angular_velocity"].as<String>());
    ESPUI.updateControlValue(C_ID_ISEMERGENCYBRAKING_LABEL, g_M010_CarStatus.isEmergencyBraking ? booleanStates["true"].as<String>() : booleanStates["false"].as<String>());
    ESPUI.updateControlValue(C_ID_ISSPEEDBUMPDETECTED_LABEL, g_M010_CarStatus.isSpeedBumpDetected ? booleanStates["true"].as<String>() : booleanStates["false"].as<String>());
    ESPUI.updateControlValue(C_ID_CURRENTSTOPTIME_SEC_LABEL, String(g_M010_CarStatus.currentStopTime_ms / 1000) + units["time_seconds"].as<String>());
}
