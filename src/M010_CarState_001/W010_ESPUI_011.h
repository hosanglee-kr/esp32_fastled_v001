...
const ControlMapEntry controlMap[] = {
    ...
    {"C_ID_MVSTATE_BUMP_SPEEDKMH_MIN"                       , C_ID_MVSTATE_BUMP_SPEEDKMH_MIN                    , &g_W010_C_ID_MVSTATE_BUMP_SPEEDKMH_MIN_Id},         // 수정됨
    {"C_ID_MVSTATE_BUMP_COOLDOWNMS"                         , C_ID_MVSTATE_BUMP_COOLDOWNMS                      , &g_W010_C_ID_MVSTATE_BUMP_COOLDOWNMS_Id},          // 수정됨
    {"C_ID_MVSTATE_DECEL_DURATIONMS_HOLD"                   , C_ID_MVSTATE_DECEL_DURATIONMS_HOLD                , &g_W010_C_ID_MVSTATE_DECEL_DURATIONMS_HOLD_Id},    // 수정됨
    {"C_ID_MVSTATE_BUMP_DURATIONMS_HOLD"                    , C_ID_MVSTATE_BUMP_DURATIONMS_HOLD                 , &g_W010_C_ID_MVSTATE_BUMP_DURATIONMS_HOLD_Id},     // 수정됨
