...
#define G_R310_NEOPIXEL_NUM_LEDS	 128
// LED 칩셋 타입
#define G_R310_LED_TYPE				 WS2812B
// LED 색상 순서 (일반적으로 GRB)
#define G_R310_COLOR_ORDER			 GRB
// 눈 색상
#define G_R310_EYE_COLOR			 CRGB::White

// --- 디스플레이 레이아웃 설정 (8x8 매트릭스 2개 기준, 전역 상수: G_R310_ 로 시작) ---
// 전체 디스플레이 너비 (픽셀)
