...
// T_R310_SimpleFontChar 구조체 형식: { 너비(항상 8), {8바이트의 비트맵 데이터} }
...
// --- 정적 데이터 테이블 정의 (PROGM0EM에 저장, g_R310_ 로 시작) ---
...
const T_R310_animFrame_t g_R310_seqBlink[] PROGMEM = {
    ...
    {{17, 17}, G_R310_FRAME_TIME / 2}, // 프레임 1: 살짝 감김
    {{18, 18}, G_R310_FRAME_TIME / 2}, // 프레임 2: 더 감김
    {{19, 19}, G_R310_FRAME_TIME / 2}, // 프레임 3: 거의 감김
    {{20, 20}, G_R310_FRAME_TIME / 2}, // 프레임 4: 거의 완전히 감김
    {{21, 21}, G_R310_FRAME_TIME},     // 프레임 5: 완전히 감김 (최대 시간 유지)
};
...
const T_R310_animFrame_t g_R310_seqRight[] PROGMEM = {
    {{ 0,  0}, G_R310_FRAME_TIME},     // 프레임 0: 기본 눈 모양
    {{ 6,  6}, G_R310_FRAME_TIME},     // 프레임 1: 눈동자 오른쪽 이동 시작
    {{ 5,  5}, G_R310_FRAME_TIME * 5}, // 프레임 2: 눈동자 오른쪽 끝 (최대 시간 유지)
};

// 왼쪽 보기 애니메이션 시퀀스 데이터
const T_R310_animFrame_t g_R310_seqLeft[] PROGMEM = {
    {{ 0,  0}, G_R310_FRAME_TIME		},		// 프레임 0: 기본 눈 모양
    {{ 7,  7}, G_R310_FRAME_TIME		},		// 프레임 1: 눈동자 왼쪽 이동 시작
    {{ 8,  8}, G_R310_FRAME_TIME * 5	}, 		// 프레임 2: 눈동자 왼쪽 끝 (최대 시간 유지)
};

// 위 보기 애니메이션 시퀀스 데이터
const T_R310_animFrame_t g_R310_seqUp[] PROGMEM = {
    {{ 0,  0}, G_R310_FRAME_TIME		},	// 프레임 0: 기본 눈 모양
    {{ 3,  3}, G_R310_FRAME_TIME		},	// 프레임 1: 눈동자 위 이동 시작
    {{ 4,  4}, G_R310_FRAME_TIME * 5	},	// 프레임 2: 눈동자 더 위로
};

// 아래 보기 애니메이션 시퀀스 데이터
const T_R310_animFrame_t g_R310_seqDown[] PROGMEM = {
    {{ 0,  0}, G_R310_FRAME_TIME		},	// 프레임 0: 기본 눈 모양
    {{ 2,  2}, G_R310_FRAME_TIME		},	// 프레임 1: 눈동자 아래 이동 시작
    {{ 1,  1}, G_R310_FRAME_TIME * 5	},	// 프레임 2: 눈동자 더 아래로
};
...
const T_R310_animFrame_t g_R310_seqAngry[] PROGMEM = {
    {{ 0,  0}, G_R310_FRAME_TIME},     // 프레임 0: 기본 눈 모양
    {{22, 17}, G_R310_FRAME_TIME},   // 프레임 1: 눈썹 찡그림 시작 (오른쪽 눈 22, 왼쪽 눈 17)
    {{23, 18}, G_R310_FRAME_TIME},   // 프레임 2: 눈썹 더 찡그림 (오른쪽 눈 23, 왼쪽 눈 18)
    {{24, 19}, G_R310_FRAME_TIME},   // 프레임 3: 눈썹 많이 찡그림 (오른쪽 눈 24, 왼쪽 눈 19)
...
const T_R310_animFrame_t g_R310_seqSad[] PROGMEM = {
    {{ 0,  0}, G_R310_FRAME_TIME},     // 프레임 0: 기본 눈 모양
    {{32, 27}, G_R310_FRAME_TIME},   // 프레임 1: 눈꼬리 처짐 시작 (오른쪽 눈 32, 왼쪽 눈 27)
    {{33, 28}, G_R310_FRAME_TIME},   // 프레임 2: 눈꼬리 더 처짐 (오른쪽 눈 33, 왼쪽 눈 28)
...
const T_R310_animFrame_t g_R310_seqEvil[] PROGMEM = {
    {{ 0,  0}, G_R310_FRAME_TIME},     // 프레임 0: 기본 눈 모양
    {{39, 37}, G_R310_FRAME_TIME},   // 프레임 1: 눈썹 치켜올림 시작 (오른쪽 눈 39, 왼쪽 눈 37)
...
const T_R310_animFrame_t g_R310_seqEvil2[] PROGMEM = {
    {{ 0,  0}, G_R310_FRAME_TIME},     // 프레임 0: 기본 눈 모양
    {{54, 17}, G_R310_FRAME_TIME},   // 프레임 1: 좌우 비대칭 눈 모양 시작 (오른쪽 54, 왼쪽 17)
    {{55, 18}, G_R310_FRAME_TIME},   // 프레임 2: 좌우 비대칭 진행 (오른쪽 55, 왼쪽 18)
    {{56, 19}, G_R310_FRAME_TIME},   // 프레임 3: 좌우 비대칭 진행 (오른쪽 56, 왼쪽 19)
...
const T_R310_animFrame_t g_R310_seqSquint[] PROGMEM = {
    {{ 0,  0}, G_R310_FRAME_TIME},     // 프레임 0: 기본 눈 모양
    {{54, 54}, G_R310_FRAME_TIME},   // 프레임 1: 눈 살짝 찡그림 시작
    {{55, 55}, G_R310_FRAME_TIME},   // 프레임 2: 눈 더 찡그림
    {{56, 56}, G_R310_FRAME_TIME},   // 프레임 3: 눈 많이 찡그림
    {{57, 57}, 2000},                // 프레임 4: 최대로 찡그린 모양 (2초 유지)
};

// 죽은 눈 애니메이션 시퀀스 데이터 (좌우 눈 동일 모양)
const T_R310_animFrame_t g_R310_seqDead[] PROGMEM = {
    {{52, 52}, G_R310_FRAME_TIME * 4},// 프레임 0: X자 눈 모양 1 (400ms 유지)
    {{53, 53}, G_R310_FRAME_TIME * 4},// 프레임 1: X자 눈 모양 2 (400ms 유지)
    {{52, 52}, G_R310_FRAME_TIME * 2},// 프레임 2: X자 눈 모양 1 (200ms 유지) - 짧게 반복되는 효과
};

// 좌우 스캔 애니메이션 시퀀스 데이터 (좌우 눈 동일 모양)
const T_R310_animFrame_t g_R310_seqScanLeftRight[] PROGMEM = {
    {{41, 41}, G_R310_FRAME_TIME * 2},// 프레임 0: 눈동자 왼쪽 끝 (200ms 유지)
    {{42, 42}, G_R310_FRAME_TIME},   // 프레임 1: 눈동자 이동
    {{43, 43}, G_R310_FRAME_TIME},   // 프레임 2: 눈동자 이동
    {{44, 44}, G_R310_FRAME_TIME},   // 프레임 3: 눈동자 오른쪽 끝
};

// 상하 스캔 애니메이션 시퀀스 데이터 (좌우 눈 동일 모양)
const T_R310_animFrame_t g_R310_seqScanUpDown[] PROGMEM = {
    {{46, 46}, G_R310_FRAME_TIME * 2},// 프레임 0: 눈동자 위쪽 중간 (200ms 유지)
    {{47, 47}, G_R310_FRAME_TIME},   // 프레임 1: 눈동자 이동
    {{48, 48}, G_R310_FRAME_TIME},   // 프레임 2: 눈동자 이동
    {{49, 49}, G_R310_FRAME_TIME},   // 프레임 3: 눈동자 이동
    {{50, 50}, G_R310_FRAME_TIME},   // 프레임 4: 눈동자 이동
    {{51, 51}, G_R310_FRAME_TIME},   // 프레임 5: 눈동자 아래 끝
};

// 찡그림 깜빡임 애니메이션 시퀀스 데이터 (좌우 눈 동일 모양)
const T_R310_animFrame_t g_R310_seqSquintBlink[] PROGMEM = {
    {{57, 57}, G_R310_FRAME_TIME},   // 프레임 0: 최대로 찡그린 모양
    {{ 5,  5}, G_R310_FRAME_TIME},     // 프레임 1: 완전히 감긴 모양
};

// 대기 상태 눈 모양 시퀀스 데이터 (정적 표시)
const T_R310_animFrame_t g_R310_seqIdle[] PROGMEM = {
    {{57, 57}, G_R310_FRAME_TIME},   // 프레임 0: 최대로 찡그린 모양 유지
};

// 하트 애니메이션 시퀀스 데이터 (좌우 눈 동일 모양)
const T_R310_animFrame_t g_R310_seqHeart[] PROGMEM = {
    {{ 0,  0}, G_R310_FRAME_TIME},     // 프레임 0: 기본 눈 모양
    {{59, 59}, G_R310_FRAME_TIME},   // 프레임 1: 하트 모양 나타남
...
const T_R310_animFrame_t g_R310_seqSleep[] PROGMEM = {
    {{ 0,  0}, G_R310_FRAME_TIME},     // 프레임 0: 기본 눈 모양
    {{62, 62}, G_R310_FRAME_TIME},   // 프레임 1: 감기기 시작
    {{63, 63}, G_R310_FRAME_TIME},   // 프레임 2: 더 감김
    {{64, 64}, G_R310_FRAME_TIME},   // 프레임 3: 더 감김
    {{65, 65}, G_R310_FRAME_TIME},   // 프레임 4: 더 감김
    {{66, 66}, G_R310_FRAME_TIME},   // 프레임 5: 더 감김
    {{67, 67}, G_R310_FRAME_TIME},   // 프레임 6: 완전히 감긴 모양 또는 패턴 등
};
...
/*
// --- 열거형 및 구조체 정의 (사용자 정의 타입: T_R310_ 로 시작) ---
// 로봇의 현재 상태
typedef enum {
    AWAKE,   // 깨어있는 상태
    SLEEPING // 잠자는 상태
...
const T_R310_animFrame_t g_R310_seqRight[] PROGMEM = {
    {{0, 0}, G_R310_FRAME_TIME},     // 프레임 0: 기본 눈 모양
    {{6, 6}, G_R310_FRAME_TIME},     // 프레임 1: 눈동자 오른쪽 이동 시작
    {{7, 7}, G_R310_FRAME_TIME * 5}, // 프레임 2: 눈동자 오른쪽 끝 (최대 시간 유지)
};

// 왼쪽 보기 애니메이션 시퀀스 데이터
const T_R310_animFrame_t g_R310_seqLeft[] PROGMEM = {
    {{0, 0}, G_R310_FRAME_TIME},     // 프레임 0: 기본 눈 모양
    {{8, 8}, G_R310_FRAME_TIME},     // 프레임 1: 눈동자 왼쪽 이동 시작
    {{9, 9}, G_R310_FRAME_TIME * 5}, // 프레임 2: 눈동자 왼쪽 끝 (최대 시간 유지)
};

// 위 보기 애니메이션 시퀀스 데이터
const T_R310_animFrame_t g_R310_seqUp[] PROGMEM = {
    {{0, 0}, G_R310_FRAME_TIME},     // 프레임 0: 기본 눈 모양
    {{11, 11}, G_R310_FRAME_TIME},   // 프레임 1: 눈동자 위 이동 시작
    {{12, 12}, G_R310_FRAME_TIME},   // 프레임 2: 눈동자 더 위로
    {{13, 13}, G_R310_FRAME_TIME * 5},// 프레임 3: 눈동자 위 끝 (최대 시간 유지)
};

// 아래 보기 애니메이션 시퀀스 데이터
const T_R310_animFrame_t g_R310_seqDown[] PROGMEM = {
    {{0, 0}, G_R310_FRAME_TIME},     // 프레임 0: 기본 눈 모양
    {{14, 14}, G_R310_FRAME_TIME},   // 프레임 1: 눈동자 아래 이동 시작
    {{15, 15}, G_R310_FRAME_TIME},   // 프레임 2: 눈동자 더 아래로
    {{16, 16}, G_R310_FRAME_TIME * 5},// 프레임 3: 눈동자 아래 끝 (최대 시간 유지)
};
...
// T_R310_emotion_t 열거형 값과 실제 애니메이션 시퀀스 데이터를 연결합니다.
// 새로운 애니메이션 시퀀스를 추가하려면 이 테이블에도 항목을 추가해야 합니다.
const T_R310_animTable_t g_R310_lookupTable[] PROGMEM = {
    {E_NEUTRAL, g_R310_seqBlink, 1},  // 중립: Blink 시퀀스의 첫 프레임만 사용 (정적)
    {E_BLINK, g_R310_seqBlink, G_R310_ARRAY_SIZE(g_R310_seqBlink)},         // 깜빡임
    {E_WINK, g_R310_seqWink, G_R310_ARRAY_SIZE(g_R310_seqWink)},             // 윙크
    {E_LOOK_L, g_R310_seqLeft, G_R310_ARRAY_SIZE(g_R310_seqLeft)},           // 왼쪽 보기
    {E_LOOK_R, g_R310_seqRight, G_R310_ARRAY_SIZE(g_R310_seqRight)},         // 오른쪽 보기
    {E_LOOK_U, g_R310_seqUp, G_R310_ARRAY_SIZE(g_R310_seqUp)},               // 위 보기
    {E_LOOK_D, g_R310_seqDown, G_R310_ARRAY_SIZE(g_R310_seqDown)},           // 아래 보기
    {E_ANGRY, g_R310_seqAngry, G_R310_ARRAY_SIZE(g_R310_seqAngry)},         // 화남
    {E_SAD, g_R310_seqSad, G_R310_ARRAY_SIZE(g_R310_seqSad)},               // 슬픔
    {E_EVIL, g_R310_seqEvil, G_R310_ARRAY_SIZE(g_R310_seqEvil)},             // 사악함
    {E_EVIL2, g_R310_seqEvil2, G_R310_ARRAY_SIZE(g_R310_seqEvil2)},         // 사악함 2
    {E_DEAD, g_R310_seqDead, G_R310_ARRAY_SIZE(g_R310_seqDead)},             // 죽은 눈
    {E_SCAN_LR, g_R310_seqScanLeftRight, G_R310_ARRAY_SIZE(g_R310_seqScanLeftRight)},// 좌우 스캔
    {E_SCAN_UD, g_R310_seqScanUpDown, G_R310_ARRAY_SIZE(g_R310_seqScanUpDown)},    // 상하 스캔
    // Idle animations
    {E_IDLE, g_R310_seqIdle, G_R310_ARRAY_SIZE(g_R310_seqIdle)},             // 대기 상태
    {E_SQUINT, g_R310_seqSquint, G_R310_ARRAY_SIZE(g_R310_seqSquint)},       // 찡그림
    {E_SQUINT_BLINK, g_R310_seqSquintBlink, G_R310_ARRAY_SIZE(g_R310_seqSquintBlink)},// 찡그림 깜빡임
    // Emojis
    {E_HEART, g_R310_seqHeart, G_R310_ARRAY_SIZE(g_R310_seqHeart)},         // 하트
    // Sleep
    {E_SLEEP, g_R310_seqSleep, G_R310_ARRAY_SIZE(g_R310_seqSleep)},         // 잠자는 눈
};
*/